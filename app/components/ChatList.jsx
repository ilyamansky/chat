...
export default function ChatList({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="w-[320px] min-w-[320px] flex flex-col h-screen border-r relative overflow-hidden border-gray-200">
      ...
      <div className="mb-2 flex flex-col px-2">
        <div className="mb-1 flex flex-row justify-end items-center relative">
                              ...
                              >
                                <div className="flex flex-col">
                                  <div className="text-custom-gray-filter">
                                    В работе по {vacancies?.length || 0}{" "}
                                    вакансиям:
                                    <hr className="my-1" />
                                  </div>
                                  <div className="flex flex-col">
